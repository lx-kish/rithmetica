import twoDigitOperands from "./two-digit-operands";

import { operations } from "../../../../TS/constatnts/constants";

describe("arythmetic - addition/subtraction - two-digit operands test suit", () => {
  const numberOfOperands = 2;

  it("should return array", () => {
    const result = twoDigitOperands(operations.addition, numberOfOperands);
  ...
  it("should return array where the first value is the sum of all the next values if the first parameter is '-'", () => {
    const result = twoDigitOperands(operations.subtraction, numberOfOperands);
  ...
  it("should return an empty array if the first parameter is NOT '+' or '-'", () => {
    const result = twoDigitOperands("", numberOfOperands);
