import twoDigitTidingUp from "./two-digit-tidying-up";

import { operations } from "../../../../TS/constants/constants";

describe("arythmetic - addition/subtraction - two-digit tidying up test suit", () => {
  const numberOfOperands = 2;

  it("should return array", () => {
    const result = twoDigitTidingUp(operations.addition, numberOfOperands);
  ...
  it("should return array where the first value is the sum of all the next values if the first parameter is '-'", () => {
    const result = twoDigitTidingUp(operations.subtraction, numberOfOperands);
  ...
  it("should return an empty array if the first parameter is NOT '+' or '-'", () => {
    const result = twoDigitTidingUp("", numberOfOperands);
