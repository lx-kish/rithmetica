...
describe("arythmetic - addition/subtraction - two-digit and tens test suit", () => {
  ...
  it("should return array", () => {
    const result = twoDigitAndTens(operations.addition, numberOfOperands);
  ...
  it("should return array where the first value is the sum of all the next values if the first parameter is '-'", () => {
    const result = twoDigitAndTens(operations.subtraction, numberOfOperands);
  ...
  it("should return an empty array if the first parameter is NOT '+' or '-'", () => {
    const result = twoDigitAndTens("", numberOfOperands);
