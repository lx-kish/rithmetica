import oneDigitDecimalsAddSubtract from "./one-digit-decimals-add-subtract";
...
describe("fractions - decimals - addition/subtraction - one digit decimals add subtract test suit", () => {
  it("should return array", () => {
    const numberOfOperands = 2;
    const result = oneDigitDecimalsAddSubtract(
      operations.addition,
      numberOfOperands
    );
  ...
  it("should return an empty array if the first parameter is NOT '+' or '-'", () => {
    const numberOfOperands = 2;
    const result = oneDigitDecimalsAddSubtract("", numberOfOperands);
  ...
  it("should return an empty array if the second parameter is null", () => {
    ...
    // @ts-ignore
    const result = oneDigitDecimalsAddSubtract(operations.addition, null);
