import tenthAddSubtract from "./tenth-add-subtract";
...
describe("fractions - decimals - addition/subtraction - tenth add subtract test suit", () => {
  it("should return array", () => {
    const numberOfOperands = 2;
    const result = tenthAddSubtract(operations.addition, numberOfOperands);
  ...
  it("should return array where the first value is the sum of all the next values if the first parameter is '-'", () => {
    const numberOfOperands = 2;
    const result = tenthAddSubtract(operations.subtraction, numberOfOperands);
  ...
  it("should return an empty array if the first parameter is NOT '+' or '-'", () => {
    const numberOfOperands = 2;
    const result = tenthAddSubtract("", numberOfOperands);
  ...
  it("should return an empty array if the second parameter is null", () => {
    ...
    // @ts-ignore
    const result = tenthAddSubtract(operations.addition, null);
