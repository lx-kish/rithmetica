import singleDigitSameDenominatorMixedFractions from "./single-digit-same-denominator-mixed-fractions";

import { operations } from "../../../../../TS/constatnts/constants";

describe("fractions - addition/subtraction - 1-digit same denominator mixed fractions test suit", () => {
  const numberOfOperands = 2;

  it("should return object", () => {
    const result = singleDigitSameDenominatorMixedFractions(
      operations.addition,
      numberOfOperands
    );
