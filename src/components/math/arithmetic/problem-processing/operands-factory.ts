...
function operandsFactory(
  ...
  try {
    ...
    if (
      ...
      return singleDigitOperandsAdditionSubtraction;
    ...
    if (
      ...
      return singleDigitOperandsMultiplicationDivision;
    if (name === "single digit and up to twenty")
      return singleDigitAndUpToTwenty;
