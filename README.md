...
- Redesign fractions problem component architecture;
...
- Fix not deleting zeros in quantity field of settings block.
...
- Redesign application interfaces;
